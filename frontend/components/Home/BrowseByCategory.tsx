      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 md:grid-cols-6 md:gap-6">
        {Categories.map((category, index) => (
          <Link key={category.id} href={category.href ?? "#"} className="group">
            <div
              className="hover-lift flex h-36 cursor-pointer flex-col items-center justify-center gap-3 rounded-xl bg-gray-100 p-4 transition-all duration-300 hover:bg-gray-200 animate-fade-up sm:h-40"
