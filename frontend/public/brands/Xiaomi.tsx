...
const Xiaomi = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <defs>
      <path id="xiaomi-a" d="M0 0h800v800H0z"></path>
    </defs>
    <clipPath id="xiaomi-b">
      <use xlinkHref="#xiaomi-a" overflow="visible"></use>
    </clipPath>
    <path
      ...
      clipPath="url(#xiaomi-b)"
      fill="#faf9f5"
    ></path>
    <defs>
      <path id="xiaomi-c" d="M0 0h800v800H0z"></path>
    </defs>
    <clipPath id="xiaomi-d">
      <use xlinkHref="#xiaomi-c" overflow="visible"></use>
    </clipPath>
    <path
      ...
      clipPath="url(#xiaomi-d)"
      fill="#faf9f5"
    ></path>
    <defs>
      <path id="xiaomi-e" d="M0 0h800v800H0z"></path>
    </defs>
    <clipPath id="xiaomi-f">
      <use xlinkHref="#xiaomi-e" overflow="visible"></use>
    </clipPath>
    <path
